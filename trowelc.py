...
# -----------------------------------------------------------------------------
# trowelc.py
# This is the main controller for Trowel
# --------------
# Usage -> ./trowel filename.twl
# Output ->
#	a. 'filename.twl' will be compiled and written into 'filename.py'
#	( b. The token stream is written into 'tokens.twl'
#	  c. The abstract syntax tree is written into 'asl.twl' )
#--------------
# There are three parts to the file
#	a. main() - The main controller
#	b. class parsewrapper
#		1. The preprocessor is contained in this class
#		2. The python-lex-yacc (PLY) modules are called from this class
#	c. class pythonwrapper
#		The python code generator is contained in this class
# -----------------------------------------------------------------------------
# Authors ->
#	This file was originally written by Hareesh.
#	All error handling was taken care of by Pucong.
#	In class pythonwrapper, David wrote the module for conditionals,
#		and Victoria wrote the module for custom functions.
#
